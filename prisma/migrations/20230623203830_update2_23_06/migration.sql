/*
  ...
  - You are about to drop the column `usuarioId` on the `LembretePadrao` table. All the data in the column will be lost.
  - You are about to drop the column `usuarioId` on the `Lembrete` table. All the data in the column will be lost.
  - You are about to drop the column `usuarioId` on the `Rotina` table. All the data in the column will be lost.
